...
function Inicie() {
    return (
        <section className="dark:bg-[#121820] bg-[#f9fafc] p-5 min-h-screen flex flex-col items-center justify-center relative">
            <div className="flex flex-col items-center">
                ...
                <div className="flex flex-row justify-center gap-2 px-15 my-3 w-full ">
                    <div className="bg-[#E3F6F5] max-w-30 flex-1 text-center py-1 rounded-2xl">
                        <a title='Descargar curriculum vitae' aria-label="Descargar curriculum vitae de Matías Buffa" href="/MatiasBuffaCVP.pdf" target="_blank" rel="noopener noreferrer" className="text-[#259E93] urbanist font-bold">
                            Ver CV
                        </a>
                    </div>
                    <div className="bg-[#E3F6F5] max-w-30 flex-1 text-center py-1 rounded-2xl">
                        <a title='Visitar LinkedIn de Matías Buffa' aria-label="Visitar perfil de LinkedIn de Matías Buffa" href="https://www.linkedin.com/in/mat%C3%ADas-buffa-b4b901358/ma" target="__blank" rel="noopener noreferrer" className="text-[#259E93] urbanist font-bold">
                            Linkedin
                        </a>
                    </div>
                </div>
