                ...
                <div>
                    <div className="dark:bg-[#121820] bg-gray-300 rounded-full py-1 px-1 inline-flex flex-row gap-2">
                        <h2 
                            ...
                            className={`font-bold open-sans text-xs hover:bg-gray-200 dark:hover:bg-[#212830] rounded-full py-1 px-2 cursor-pointer ${optionSelected == "Todos" ? "bg-gray-200 dark:bg-[#212830]" : ""}`}>Todos</h2>
                        <h2 
                            onClick={()=>{handleOption("Frontend")}}
                            className={`font-bold open-sans text-xs hover:bg-gray-200 dark:hover:bg-[#212830] rounded-full py-1 px-2 cursor-pointer ${optionSelected == "Frontend" ? "bg-gray-200 dark:bg-[#212830]" : ""}`}>Frontend</h2>
                        <h2 
                            onClick={()=>{handleOption("Backend")}}
                            className={`font-bold open-sans text-xs hover:bg-gray-200 dark:hover:bg-[#212830] rounded-full py-1 px-2 cursor-pointer ${optionSelected == "Backend" ? "bg-gray-200 dark:bg-[#212830]" : ""}`}>Backend</h2>
                        <h2 
                            onClick={()=>{handleOption("Fullstack")}}
                            className={`font-bold open-sans text-xs hover:bg-gray-200 dark:hover:bg-[#212830] rounded-full py-1 px-2 cursor-pointer ${optionSelected == "FullStack" ? "bg-gray-200 dark:bg-[#212830]" : ""}`}>Fullstack</h2>
                    </div>
                </div>
                <div>
