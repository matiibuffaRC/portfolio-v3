...
function ProyectCard({ proyect, index }: ProyectCardProps) {
    ...
    return (
        ...
        <div ref={cardRef} className={`proyect-card ${visible ? "show" : ""} flex flex-col md:flex-row gap-10 md:gap-4 py-5 border-b-2 border-gray-300 dark:border-gray-900 ${index % 2 != 1 ? "md:flex-row-reverse" : ""} `} style={{ transitionDelay: `${0.1}s`, }} >
            <div className="flex-1 flex flex-col justify-between gap-3 md:gap-0 ">
                ...
                <div className="flex flex-row items-center gap-2">
                    ...
                    <div className="flex flex-row items-center gap-1 dark:bg-[#121820] bg-gray-300 px-3 py-1.5 rounded-full">
                        ...
                        <a href={proyect.code} target="__blank" className="urbanist font-bold cursor-pointer" >
                            Código
                        </a>
                    </div>
                </div>
